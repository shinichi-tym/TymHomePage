...
- 写真表示：ランダムで写真を表示します。
- 写真表示：タップすると拡大表示します。(*1)
- TYM ホーム 権限設定：アプリ情報を表示し，権限を変更できます。

*1 今後サポート予定
*2 写真表示には，アプリの権限（ストレージ）が必要です。

【設定モード】

- 画面の "秒" の部分を５回タップします。 => "秒" が赤くなります。
- 左上のTYMアイコンをクリックするとスパナアイコンに変わり設定モードになります。
- スパナアイコンをタップすると，元に戻ります。
...
![スクリーンショット4](/tyn_home_screenshot_5_tel_setting.png)
